...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Niki-OPSS MARKET', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Niki-OPSS MARKET', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https:/blog.opssmarket.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Niki-OPSS MARKET', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Ciao Sono Niki Sono Un Collezionalista di Trading Card Game',
