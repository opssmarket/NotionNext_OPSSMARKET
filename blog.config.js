...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'OPSS MARKET', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'OPSS MARKET', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https:/blog.opssmarket.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'OPSS MARKET', // 网站关键词 英文逗号隔开
